      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            <h6>Welcome to Epic Quest Games</h6>
            <h2>BEST RPG GENRE EVER!</h2>
            <p>An RPG game lets you dive into epic adventures, shape your own story, and become the hero of a world full of endless possibilities! </p>
            
          </div>
        </div>
        <div class="col-lg-4 offset-lg-2">
          <div class="right-image">
            <img src="assets/images/the-witcher-3-best-rpgs-ezgif.com-webp-to-png-converter.png" alt="">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="subscribe">
            <div class="row">
              <div class="col-lg-12">
                <div class="section-heading">
                  <h6>NEWSLETTER</h6>
                  <h2>Get Up To ₱2,100 Off Just Buy <em>Subscribe</em> Newsletter!</h2>
                </div>
